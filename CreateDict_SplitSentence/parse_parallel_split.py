...
from culture import file_util, preprocess_parallel_split
...
if __name__ == "__main__":
    with CoreNLPClient(
        ...
        out_file = Path(
            global_options.DATA_FOLDER, "processed", "parsed", "documents_split.txt"
        )
        output_index_file = Path(
            global_options.DATA_FOLDER, "processed", "parsed", "document_sent_ids_split.txt"
        )
        process_largefile(
            input_file=in_file,
            ...
            function_name=preprocess_parallel_split.process_document,
